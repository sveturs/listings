// frontend/hostel-frontend/src/components/marketplace/AutoDetails.tsx
...
interface AutoDetailsProps {
    autoProperties: AutoProperties | null;
}

const AutoDetails: React.FC<AutoDetailsProps> = ({ autoProperties }) => {
    ...
    const translateBodyType = (bodyType?: string): string => {
    ...
    const translateDriveType = (driveType?: string): string => {
