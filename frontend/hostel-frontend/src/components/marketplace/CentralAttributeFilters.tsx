// frontend/hostel-frontend/src/components/marketplace/CentralAttributeFilters.tsx
...
interface CentralAttributeFiltersProps {
...
const CentralAttributeFilters: React.FC<CentralAttributeFiltersProps> = ({
    categoryId,
    onFilterChange,
    filters = {},
        ...
        const fetchDebugData = async (): Promise<void> => {
            try {
                ...
                if (response.data?.data) {
                    const filterableAttrs = response.data.data.filter((attr: any) => attr.is_filterable);
                    ...
                    setDebugData({
                        ...
                        attributes: filterableAttrs.map((a: any) => a.name)
                    });
    ...
    const handleAttributesLoaded = useCallback((hasAny: boolean) => {
