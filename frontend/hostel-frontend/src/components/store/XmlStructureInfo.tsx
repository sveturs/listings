// frontend/hostel-frontend/src/components/store/XmlStructureInfo.tsx
...
const XmlStructureInfo: React.FC = () => {
  ...
  return (
    <Box sx={{ mt: 3 }}>
      {/* @ts-ignore - Игнорируем ошибку типов для Accordion */}
      <Accordion>
        <AccordionSummary
