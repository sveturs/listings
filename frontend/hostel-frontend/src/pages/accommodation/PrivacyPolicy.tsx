...
// Определение типов для структуры политики конфиденциальности
...
interface PolicyTexts {
  [key: string]: PolicyText;
}

// Полные тексты политик на разных языках
const policyTexts: PolicyTexts = {
  en: {
    ...
    sections: [
      {
        ...
        content: `SveTu.rs ("we", "our", or "us") is committed to protecting your privacy. 
  ...
  sr: {
    ...
    sections: [
      {
        title: "1. Uvod",
        content: `SveTu.rs („mi", „naš" ili „nas") je posvećen zaštiti vaše privatnosti. 
  ...
  ru: {
    ...
    sections: [
      {
        title: "1. Введение",
        content: `SveTu.rs ("мы", "наш" или "нас") обеспечивает защиту вашей конфиденциальности. 
...
const PrivacyPolicy: React.FC = () => {
  ...
  const renderContent = (sections: PolicyItem[]) => {
