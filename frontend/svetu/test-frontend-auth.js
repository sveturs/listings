...
async function testLogin() {
  ...
  console.log(
    '  Access token:',
    loginData.access_token?.substring(0, 50) + '...'
  );
  console.log(
    '  Refresh token:',
    loginData.refresh_token?.substring(0, 50) + '...'
  );
  ...
  if (refreshResponse.ok) {
    ...
    console.log(
      '  New access token:',
      refreshData.access_token?.substring(0, 50) + '...'
    );
    console.log(
      '  New refresh token:',
      refreshData.refresh_token?.substring(0, 50) + '...'
    );
  } else {
