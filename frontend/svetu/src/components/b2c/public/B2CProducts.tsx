...
interface B2CProductsProps {
  storefrontSlug: string;
}

export default function B2CProducts({ storefrontSlug }: B2CProductsProps) {
      ...
      <div className="card-body">
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link 
              href={`/${locale}/b2c/${storefrontSlug}/products`}
        ...
        <div className={
          ...
          {Array.isArray(products) ? products.map((product) => (
            viewMode === 'grid' ? (
              <Link 
                key={product.id} 
                href={`/${locale}/b2c/${storefrontSlug}/products/${product.id}`}
