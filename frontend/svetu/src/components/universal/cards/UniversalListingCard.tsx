...
const UniversalListingCard: FC<UniversalListingCardProps> = memo(
  function UniversalListingCard({
    data,
    type = 'marketplace',
    layout = 'grid',
    showBadges = true,
    ...
    const config = useMemo(() => CARD_CONFIG[type], [type]);
    ...
    const canCompare = useMemo(
      () => config.compareEnabled && showCompare,
      [config.compareEnabled, showCompare]
    );
    ...
    const handleFavoriteClick = useCallback(
      ...
      [isFavorite, dispatch, data.id, type]
    );
