            ...
            {isOwner ? (
              <>
                <button 
                  ...
                  onClick={() => router.push(`/${locale}/storefront-dashboard`)}
                >
              ...
              <>
                ...
                >
                  ...
                  {isFollowing ? t('storefronts.following') : t('storefronts.follow')}
                </button>
              </>
            )}
      ...
      {shareOpen && (
        <div className="modal modal-open">
          <div className="modal-box">
            <h3 className="font-bold text-lg">{t('storefronts.shareStore')}</h3>
            <div className="py-4">
              <div className="form-control">
                <label className="label">
                  <span className="label-text">{t('storefronts.storeLink')}</span>
                </label>
