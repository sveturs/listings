...
import AdminStorefrontProductsTable from './AdminStorefrontProductsTable';
...
export default async function StorefrontProductsPage({ params }: PageProps) {
