  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-6">
        <div>
          <h1 className="text-3xl font-bold">{t('storefronts.title')}</h1>
      ...
      <div className="stats shadow mb-6 w-full">
        <div className="stat">
          ...
          <div className="stat-title">{t('storefronts.stats.total')}</div>
          <div className="stat-value">{stats.total}</div>
          <div className="stat-desc">{t('storefronts.stats.totalDesc')}</div>
        </div>
        ...
        <div className="stat">
          ...
          <div className="stat-title">{t('storefronts.stats.active')}</div>
          <div className="stat-value">{stats.active}</div>
          <div className="stat-desc">{t('storefronts.stats.activeDesc')}</div>
        </div>
        ...
        <div className="stat">
          ...
          <div className="stat-title">{t('storefronts.stats.verified')}</div>
          <div className="stat-value">{stats.verified}</div>
          <div className="stat-desc">{t('storefronts.stats.verifiedDesc')}</div>
        </div>
        ...
        <div className="stat">
          ...
          <div className="stat-title">{t('storefronts.stats.products')}</div>
          <div className="stat-value">{stats.totalProducts}</div>
          <div className="stat-desc">{t('storefronts.stats.productsDesc')}</div>
        </div>
        ...
        <div className="stat">
          ...
          <div className="stat-title">{t('storefronts.stats.sales')}</div>
          <div className="stat-value">{stats.totalSales.toLocaleString()}</div>
          <div className="stat-desc">{t('storefronts.stats.salesDesc')}</div>
        </div>
      </div>
