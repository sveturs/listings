...
export default function AdminB2CProductsTable() {
  ...
  const fetchProducts = useCallback(async () => {
    ...
    try {
      ...
      const storefronts =
        storefrontsData.b2c_stores ||
        storefrontsData.storefronts ||
        storefrontsData.data ||
        [];
  ...
  useEffect(() => {
    ...
    router.push(`/${locale}/admin/b2c-products${newUrl}`, {
      scroll: false,
    });
  }, [
    searchQuery,
                  ...
                  products.map((product) => (
                    <tr key={product.id}>
                      ...
                      <td>
                        <div className="flex items-center gap-1">
                          <Link
                            href={`/${locale}/b2c/${product.storefront_slug || product.storefront?.slug || product.storefront_id}/products/${product.id}`}
                          ...
                          <Link
                            href={`/${locale}/admin/b2c-products/${product.id}/edit`}
                            className="btn btn-ghost btn-xs"
                          >
                            <svg
                              className="w-4 h-4"
