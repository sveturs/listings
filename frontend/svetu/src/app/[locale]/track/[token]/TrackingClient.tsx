    ...
    const fetchDelivery = async () => {
      try {
        ...
        if (data.courier_location) {
          setCourierLocation({
            latitude: data.courier_location.latitude,
            longitude: data.courier_location.longitude,
            speed: data.courier_location.speed || 0,
            heading: data.courier_location.heading || 0,
            updatedAt: data.courier_location.updated_at,
          });
        }
      } catch (err) {
