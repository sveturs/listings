...
export default function TestAuthPage() {
  ...
  const setAdminUser = () => {
    try {
      ...
      setStatus(`✓ Установлен пользователь С правами админа: ${adminUser.email}`);
      setError('');
    ...
    <div className="container mx-auto p-8">
      ...
      <div className="bg-base-200 p-6 rounded-lg">
        ...
        <ol className="list-decimal list-inside space-y-2">
          <li>Нажмите "Установить обычного пользователя" для создания пользователя без прав админа</li>
          <li>Нажмите "Перейти в админ-панель"</li>
          <li>AdminGuard должен заблокировать доступ и перенаправить на главную</li>
