...
import ImageGallery from '@/components/c2c/listing/ImageGallery';
import SellerInfo from '@/components/c2c/listing/SellerInfo';
import ListingActions from '@/components/c2c/listing/ListingActions';
import SimilarListings from '@/components/c2c/listing/SimilarListings';
          ...
          <div className="text-sm breadcrumbs">
            <ul>
              ...
              {listing.category_path_names?.map((name, index) => (
                <li key={index}>
                  <Link
                    href={`/${locale}/c2c?category=${listing.category_path_ids?.[index]}`}
                  >
                    {name}
                  </Link>
                </li>
