    ...
    <div className="min-h-screen bg-gradient-to-br from-base-100 to-base-200">
          ...
          <div className="flex items-center gap-3">
            <div className="avatar online">
              <div className="w-10 rounded-full">
                <img src="https://ui-avatars.com/api/?name=Tech+Store&background=6366f1&color=fff" alt="Seller" />
              </div>
            </div>
            <div>
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="flex h-[calc(100vh-64px)]">
          ...
          <div className="flex-1 flex flex-col">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-4">
              {messages.map((message, idx) => (
                <AnimatedSection 
                  key={message.id} 
                  animation={message.sender === 'buyer' ? 'slideRight' : 'slideLeft'}
                  delay={idx * 0.1}
                >
                  <div className={`flex ${message.sender === 'buyer' ? 'justify-end' : 'justify-start'}`}>
                    <div className={`max-w-xs lg:max-w-md ${message.sender === 'buyer' ? 'order-2' : ''}`}>
                      <div className={`relative px-4 py-2 rounded-2xl ${
                        ...
                        <p>{message.text}</p>
                        <span className={`text-xs ${message.sender === 'buyer' ? 'text-primary-content/70' : 'text-base-content/60'}`}>
                          {message.time}
                        </span>
                ...
                {showEmojiPicker && (
                  <AnimatedSection animation="slideUp">
                    <div className="bg-base-200 rounded-lg p-4 mt-2">
                      <h4 className="font-semibold mb-2">Анимированные эмодзи</h4>
          ...
          {/* Sidebar Info */}
          <AnimatedSection animation="slideRight" delay={0.3} className="hidden lg:block w-80 p-4">
            <div className="card bg-base-100 shadow-xl">
              <div className="card-body">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-base-content/60">Нажмите на сообщение чтобы добавить реакцию</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-base-content/60">Используйте готовые фразы для быстрого ответа</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-base-content/60">Эмодзи с анимацией для ярких эмоций</p>
                    </div>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-base-content/60">Получайте уведомления о важных сообщениях</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-info/10 rounded-lg p-3">
                  ...
                  <p className="text-sm mt-2">Все сообщения шифруются и защищены. Используйте эскроу для безопасных сделок.</p>
                </div>
              </div>
            </div>
          </AnimatedSection>
