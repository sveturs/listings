          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="card bg-primary/10">
              <div className="card-body text-center">
                ...
                <p className="text-sm">
                  AI определяет тип товара, состояние и ключевые характеристики
                </p>
              </div>
            </div>
            <div className="card bg-secondary/10">
              <div className="card-body text-center">
                ...
                <p className="text-sm">
                  Анализ рынка и рекомендация оптимальной цены
                </p>
              </div>
            </div>
            <div className="card bg-accent/10">
              <div className="card-body text-center">
                ...
                <p className="text-sm">
                  Автоматическая генерация тегов и ключевых слов
                </p>
              </div>
            </div>
          </div>
