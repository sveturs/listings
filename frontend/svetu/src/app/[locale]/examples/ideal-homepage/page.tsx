    ...
    <div className="min-h-screen bg-gradient-to-b from-base-100 to-base-200">
      ...
      <header className="navbar bg-base-100/80 backdrop-blur-md sticky top-0 z-50 shadow-sm">
        ...
        <nav className="navbar-center hidden lg:flex">
          <ul className="menu menu-horizontal px-1">
            ...
            <li><a href="#storefronts">Магазины</a></li>
        ...
        <div className="navbar-end">
          ...
          <Link href="/auth/login" className="btn btn-ghost btn-sm hidden lg:flex">
            Войти
          </Link>
        ...
        <div className="hero-content text-center py-20">
          <AnimatedSection animation="fadeIn">
            <div className="max-w-4xl">
              ...
              <p className="text-xl lg:text-2xl mb-10 text-base-content/80">
                Покупайте и продавайте с комфортом на главной платформе Сербии
              </p>

              {/* Search Bar */}
              <AnimatedSection animation="slideUp" delay={0.2}>
                <div className="card bg-base-100 shadow-2xl p-6 mb-8">
        ...
        <div className="container mx-auto max-w-7xl">
          <AnimatedSection animation="fadeIn">
            <div className="text-center mb-10">
              <h2 className="text-3xl lg:text-4xl font-bold mb-4">🔥 Горячие предложения</h2>
              <p className="text-lg text-base-content/70">Самые популярные товары прямо сейчас</p>
            </div>
          </AnimatedSection>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {popularProducts.map((product, idx) => (
              <AnimatedSection key={product.id} animation="slideUp" delay={idx * 0.1}>
                <div className="card bg-base-100 shadow-xl hover:shadow-2xl transition-all hover:-translate-y-2">
                  {product.isNew && (
                    <div className="badge badge-secondary absolute top-2 left-2 z-10">Новое</div>
                  )}
                  {product.isPromoted && (
                    <div className="badge badge-warning absolute top-2 left-2 z-10">Промо</div>
                  )}
                  {product.discount && (
                    <div className="badge badge-error absolute top-2 right-2 z-10">-{product.discount}%</div>
                  )}
      ...
      <section className="py-16 bg-gradient-to-r from-red-50 to-orange-50">
        <div className="container mx-auto max-w-7xl px-4">
          <AnimatedSection animation="fadeIn">
            <div className="text-center mb-10">
              <h2 className="text-3xl lg:text-4xl font-bold mb-4">🏷️ Товары со скидкой</h2>
              <p className="text-lg text-base-content/70">Успейте купить по выгодной цене!</p>
            </div>
          </AnimatedSection>

          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {[
              { title: 'Samsung TV 55"', price: 599, oldPrice: 899, discount: 33, image: config.buildImageUrl('/listings/20/1753428897128302370.jpg') },
              { title: 'Nike Air Max', price: 89, oldPrice: 149, discount: 40, image: config.buildImageUrl('/listings/21/1753445822265644326.jpg') },
              { title: 'PlayStation 5', price: 449, oldPrice: 549, discount: 18, image: config.buildImageUrl('/listings/23/1753548160663849380.jpg') },
              { title: 'iPad Air', price: 549, oldPrice: 699, discount: 21, image: config.buildImageUrl('/listings/24/1753549239639443133.jpg') },
              { title: 'Canon EOS R5', price: 2999, oldPrice: 3999, discount: 25, image: config.buildImageUrl('/listings/25/1753550885742188000.jpg') },
              { title: 'Dyson V15', price: 399, oldPrice: 599, discount: 33, image: config.buildImageUrl('/listings/26/1753554432788980038.jpg') },
            ].map((product, idx) => (
              <AnimatedSection key={idx} animation="zoomIn" delay={idx * 0.05}>
                <div className="card bg-base-100 shadow-lg hover:shadow-2xl transition-all hover:-translate-y-1">
                  <figure className="relative h-32">
                    ...
                    <div className="absolute top-2 right-2 badge badge-error">-{product.discount}%</div>
                  </figure>
                  <div className="card-body p-3">
                    <h3 className="text-sm font-semibold line-clamp-2">{product.title}</h3>
                    <div>
                      <div className="text-lg font-bold text-error">€{product.price}</div>
                      <div className="text-xs text-base-content/50 line-through">€{product.oldPrice}</div>
                    </div>
                  </div>
                </div>
              </AnimatedSection>
          ...
          <AnimatedSection animation="fadeIn" delay={0.3}>
            <div className="text-center mt-8">
              ...
              <p className="text-sm text-base-content/60 mt-2">До конца акции</p>
            </div>
          </AnimatedSection>
        </div>
      </section>
      ...
      <section className="py-16 bg-black text-white">
        <div className="container mx-auto max-w-7xl px-4">
          <AnimatedSection animation="fadeIn">
            <div className="text-center mb-10">
              <h2 className="text-3xl lg:text-4xl font-bold mb-4">⚡ Черная пятница в витринах</h2>
              <p className="text-lg opacity-80">Официальные магазины с мега-скидками</p>
            </div>
          </AnimatedSection>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { name: 'TechnoWorld', category: 'Электроника', discount: 'до 70%', followers: '125K', logo: '🖥️', color: 'from-blue-600 to-purple-600' },
              { name: 'FashionHub', category: 'Одежда и обувь', discount: 'до 80%', followers: '89K', logo: '👗', color: 'from-pink-600 to-red-600' },
              { name: 'HomeDecor', category: 'Дом и сад', discount: 'до 60%', followers: '67K', logo: '🏡', color: 'from-green-600 to-teal-600' },
              { name: 'SportMaster', category: 'Спорт и отдых', discount: 'до 50%', followers: '234K', logo: '⚽', color: 'from-orange-600 to-red-600' },
            ].map((store, idx) => (
                ...
                <div className="card bg-gray-900 border border-gray-800 hover:border-yellow-400 transition-all">
                  <div className="card-body">
                    <div className="flex items-start justify-between mb-4">
                      <div className={`w-16 h-16 rounded-xl bg-gradient-to-r ${store.color} flex items-center justify-center text-3xl`}>
                        {store.logo}
                      </div>
                      <div className="badge badge-warning badge-lg">BLACK FRIDAY</div>
                    </div>
                    <h3 className="text-xl font-bold">{store.name}</h3>
                    <p className="text-sm opacity-70">{store.category}</p>
                    <div className="text-3xl font-bold text-yellow-400 my-2">{store.discount}</div>
                    <div className="flex items-center justify-between mt-auto">
                      <span className="text-sm opacity-60">{store.followers} подписчиков</span>
                      <button className="btn btn-sm btn-warning">В магазин</button>
                    </div>
                  </div>
                </div>
              </AnimatedSection>
      ...
      <section className="py-16 px-4">
        <div className="container mx-auto max-w-7xl">
          <AnimatedSection animation="fadeIn">
            <div className="text-center mb-10">
              <h2 className="text-3xl lg:text-4xl font-bold mb-4">🗺️ Товары рядом с вами</h2>
              <p className="text-lg text-base-content/70">Найдите то, что нужно, в вашем районе</p>
            </div>
          </AnimatedSection>
            ...
            <div className="card bg-base-100 shadow-2xl overflow-hidden">
              <div className="relative h-96 bg-gradient-to-br from-blue-50 to-green-50">
                ...
                <div className="absolute inset-0 opacity-20">
                  {[...Array(10)].map((_, i) => (
                    <div key={i} className="absolute w-full border-t border-gray-300" style={{ top: `${i * 10}%` }}></div>
                  ))}
                  {[...Array(10)].map((_, i) => (
                    <div key={i} className="absolute h-full border-l border-gray-300" style={{ left: `${i * 10}%` }}></div>
                  ))}
                </div>
              ...
              <div className="card-body">
                <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
                  <div>
                    <h3 className="text-xl font-bold">Интерактивная карта товаров</h3>
                    <p className="text-sm text-base-content/60">Настройте фильтры и найдите нужное рядом</p>
                  </div>
                  <button className="btn btn-primary">
                    Открыть карту
                    <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="container mx-auto max-w-7xl px-4">
          <AnimatedSection animation="fadeIn">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-base-content/70">Инновационные функции для вашего удобства</p>
            </div>
          </AnimatedSection>
              ...
              <AnimatedSection key={idx} animation="zoomIn" delay={idx * 0.1}>
                <div className="card bg-base-100 shadow-xl hover:shadow-2xl transition-all group">
                  <div className="card-body items-center text-center">
                    <div className={`w-20 h-20 rounded-2xl bg-gradient-to-r ${feature.color} flex items-center justify-center text-4xl mb-4 group-hover:scale-110 transition-transform`}>
                      {feature.icon}
                    </div>
        ...
        <div className="container mx-auto max-w-7xl">
          <AnimatedSection animation="fadeIn">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-base-content/70">4 сценария использования платформы</p>
            </div>
          </AnimatedSection>
              ...
              <div className="card bg-gradient-to-br from-primary/10 to-primary/5 border border-primary/20 h-full">
                <div className="card-body">
                  <div className="text-center mb-4">
                    ...
                    <p className="text-sm text-base-content/60">Частные объявления</p>
                  </div>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-base-content/60">AI создаст описание</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary">💰</span>
                      <div>
                        ...
                        <p className="text-xs text-base-content/60">С учетом рынка</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary">🚀</span>
                      <div>
                        ...
                        <p className="text-xs text-base-content/60">Мгновенно онлайн</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-primary">✅</span>
                      <div>
                        ...
                        <p className="text-xs text-base-content/60">Через эскроу</p>
                      </div>
                    </li>
                  </ul>
                </div>
              ...
              <div className="card bg-gradient-to-br from-secondary/10 to-secondary/5 border border-secondary/20 h-full">
                <div className="card-body">
                  <div className="text-center mb-4">
                    ...
                    <p className="text-sm text-base-content/60">Витрина магазина</p>
                  </div>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      <span className="text-secondary">🏪</span>
                      <div>
                        <p className="font-semibold text-sm">Создайте витрину</p>
                        <p className="text-xs text-base-content/60">Брендированный магазин</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-secondary">📦</span>
                      <div>
                        <p className="font-semibold text-sm">Загрузите каталог</p>
                        <p className="text-xs text-base-content/60">Массовая загрузка</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-secondary">📊</span>
                      <div>
                        ...
                        <p className="text-xs text-base-content/60">Dashboard с метриками</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-secondary">💳</span>
                      <div>
                        ...
                        <p className="text-xs text-base-content/60">Интеграция с банками</p>
                      </div>
                    </li>
                  </ul>
                </div>
              ...
              <div className="card bg-gradient-to-br from-accent/10 to-accent/5 border border-accent/20 h-full">
                <div className="card-body">
                  <div className="text-center mb-4">
                    ...
                    <p className="text-sm text-base-content/60">Покупки у частных лиц</p>
                  </div>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-base-content/60">AI-рекомендации</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-accent">💬</span>
                      <div>
                        ...
                        <p className="text-xs text-base-content/60">Живые эмодзи</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-accent">🤝</span>
                      <div>
                        ...
                        <p className="text-xs text-base-content/60">Или доставка</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-accent">🔒</span>
                      <div>
                        <p className="font-semibold text-sm">Безопасная сделка</p>
                        <p className="text-xs text-base-content/60">Эскроу-защита</p>
                      </div>
                    </li>
                  </ul>
                </div>
              ...
              <div className="card bg-gradient-to-br from-info/10 to-info/5 border border-info/20 h-full">
                <div className="card-body">
                  <div className="text-center mb-4">
                    ...
                    <p className="text-sm text-base-content/60">Покупки в магазинах</p>
                  </div>
                  <ul className="space-y-3">
                    <li className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-base-content/60">Официальные магазины</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-base-content/60">Черная пятница</p>
                      </div>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-info">🚚</span>
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <p className="text-xs text-base-content/60">Возврат и обмен</p>
                      </div>
                    </li>
                  </ul>
                </div>
      ...
      <section className="py-16 bg-gradient-to-r from-primary to-secondary text-primary-content">
        <div className="container mx-auto max-w-6xl px-4">
          <AnimatedSection animation="fadeIn">
            <div className="text-center mb-12">
              <h2 className="text-3xl lg:text-4xl font-bold mb-4">Наши достижения</h2>
            ...
            <AnimatedSection animation="slideLeft">
              <div>
                ...
                <p className="text-lg text-base-content/70 mb-8">
                  Скачайте мобильное приложение и получите доступ к миллионам товаров в вашем кармане
                </p>
                  ...
                  <div>
                    <div className="flex items-center gap-1">
                      <div className="rating rating-sm">
                        {[1,2,3,4,5].map(star => (
                          <input key={star} type="radio" className="mask mask-star-2 bg-orange-400" checked={star <= 5} readOnly />
                        ))}
                      </div>
                      <span className="font-bold">4.9</span>
                    </div>
                    <p className="text-sm text-base-content/60">из 50K+ отзывов</p>
                  </div>
                </div>
              </div>
            </AnimatedSection>
                ...
                <div className="display">
                  <div className="artboard artboard-demo phone-1 bg-base-100">
                    <div className="w-full h-full flex items-center justify-center">
                      <img 
                        src={config.buildImageUrl('/listings/7/1753007242863504454.jpg')} 
                        alt="App Screenshot"
