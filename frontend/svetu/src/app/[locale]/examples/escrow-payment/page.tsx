...
const EscrowPayment = () => {
  ...
  const [dealStatus, setDealStatus] = useState<'pending' | 'paid' | 'shipped' | 'delivered' | 'completed'>('pending');
  ...
  const escrowSteps = [
    ...
    { id: 2, title: 'Оплата', icon: '💳', status: currentStep >= 2 ? 'completed' : 'pending' },
    { id: 3, title: 'Доставка', icon: '📦', status: currentStep >= 3 ? 'completed' : 'pending' },
    { id: 4, title: 'Получение', icon: '✅', status: currentStep >= 4 ? 'completed' : 'pending' },
    { id: 5, title: 'Завершение', icon: '🎉', status: currentStep >= 5 ? 'completed' : 'pending' },
  ];
                    ...
                    <div className="flex-1">
                      ...
                      <div className="mt-2 space-y-1 text-sm">
                        <div className="flex justify-between">
                          <span className="text-base-content/60">Продавец:</span>
                          <span className="font-semibold">{product.seller}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-base-content/60">Покупатель:</span>
                ...
                <div className="card bg-base-100 shadow-xl">
                  <div className="card-body">
                    ...
                    <div className="space-y-3">
                      <label className={`card cursor-pointer ${paymentMethod === 'card' ? 'ring-2 ring-primary' : ''}`}>
                        <div className="card-body p-4">
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1">
                              ...
                              <div className="text-sm text-base-content/60">Visa, Mastercard, Мир</div>
                            </div>
                      ...
                      <label className={`card cursor-pointer ${paymentMethod === 'bank' ? 'ring-2 ring-primary' : ''}`}>
                        <div className="card-body p-4">
                          <div className="flex items-center gap-3">
                            <input
                              type="radio"
                            ...
                            <div className="flex-1">
                              ...
                              <div className="text-sm text-base-content/60">SWIFT, SEPA</div>
                            </div>
                          </div>
                        </div>
                      </label>

                      <label className={`card cursor-pointer ${paymentMethod === 'crypto' ? 'ring-2 ring-primary' : ''}`}>
                        <div className="card-body p-4">
                          <div className="flex items-center gap-3">
                            <input
                              type="radio"
                            ...
                            <div className="flex-1">
                              ...
                              <div className="text-sm text-base-content/60">Bitcoin, Ethereum, USDT</div>
                            </div>
              ...
              <AnimatedSection animation="fadeIn">
                <div className="card bg-success/10 border border-success">
                  <div className="card-body text-center">
                    ...
                    <h3 className="text-2xl font-bold text-success">Оплата получена!</h3>
                    <p className="mt-2">Средства находятся на эскроу-счете до подтверждения получения товара</p>
                    <div className="loading loading-dots loading-lg text-success mt-4"></div>
                    <p className="text-sm text-base-content/60 mt-2">Ожидание отправки товара продавцом...</p>
                  </div>
                </div>
              </AnimatedSection>
            )}
                  ...
                  <div className="card-body">
                    ...
                    <div className="bg-info/10 rounded-lg p-4 mb-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="font-semibold">Трек-номер: RS123456789</p>
                          <p className="text-sm text-base-content/60">Курьерская служба: DHL Express</p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-3">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-base-content/60">Сегодня, 10:30</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-base-content/60">Ожидаемая доставка: завтра</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1 opacity-50">
                          ...
                          <p className="text-sm text-base-content/60">Ожидается</p>
                        </div>
                      </div>
                    </div>

                    <button className="btn btn-primary btn-block mt-4" onClick={handleDeliveryConfirm}>
                    ...
                    <div className="space-y-4">
                      <div className="form-control">
                        <label className="label cursor-pointer">
                          <span className="label-text">Товар получен в полной комплектации</span>
                          <input type="checkbox" className="checkbox checkbox-primary" defaultChecked />
                        </label>
                      </div>
                      <div className="form-control">
                        <label className="label cursor-pointer">
                          <span className="label-text">Товар соответствует описанию</span>
                          <input type="checkbox" className="checkbox checkbox-primary" defaultChecked />
                        </label>
                      </div>
                      <div className="form-control">
                        <label className="label cursor-pointer">
                          <span className="label-text">Претензий к продавцу нет</span>
                          <input type="checkbox" className="checkbox checkbox-primary" defaultChecked />
                        </label>
                      </div>
                      ...
                      <button className="btn btn-success btn-block" onClick={handleDealComplete}>
                        Завершить сделку
                      </button>
                    </div>
                  </div>
              ...
              <AnimatedSection animation="zoomIn">
                <div className="card bg-gradient-to-r from-success/10 to-primary/10 border-2 border-success">
                  <div className="card-body text-center">
                    ...
                    <h3 className="text-3xl font-bold text-success">Сделка завершена!</h3>
                    <p className="mt-2 text-lg">Спасибо за использование эскроу-защиты</p>
                    ...
                    <button className="btn btn-primary mt-6">Перейти к покупкам</button>
                  </div>
                </div>
              </AnimatedSection>
            )}
                  ...
                  <div className="space-y-4">
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-base-content/60">Деньги хранятся на защищенном счете</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-base-content/60">Отслеживание на всех этапах</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-base-content/60">100% возврат при проблемах</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-base-content/60">Независимое решение конфликтов</p>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="join join-vertical w-full">
                    <div className="collapse collapse-arrow join-item border border-base-300">
                      ...
                      <div className="collapse-content text-sm">
                        <p>Вы можете открыть спор и получить полный возврат средств</p>
                      </div>
                    </div>
                    <div className="collapse collapse-arrow join-item border border-base-300">
                      ...
                      <div className="collapse-content text-sm">
                        <p>У вас есть 3 дня после получения для проверки товара</p>
                      </div>
                    </div>
                  </div>
                </div>
