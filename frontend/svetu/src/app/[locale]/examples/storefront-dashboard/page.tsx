                  ...
                  <div className="card-body">
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <p
                          className={`text-sm ${stats.revenue.trend === 'up' ? 'text-success' : 'text-error'}`}
                        >
                  ...
                  <div className="card-body">
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <p
                          className={`text-sm ${stats.orders.trend === 'up' ? 'text-success' : 'text-error'}`}
                        >
                  ...
                  <div className="card-body">
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <p
                          className={`text-sm ${stats.visitors.trend === 'up' ? 'text-success' : 'text-error'}`}
                        >
                  ...
                  <div className="card-body">
                    <div className="flex justify-between items-start">
                      <div>
                        ...
                        <p
                          className={`text-sm ${stats.conversion.trend === 'up' ? 'text-success' : 'text-error'}`}
                        >
                    ...
                    <table className="table">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>€249</td>
                          <td>
                            <span className="badge badge-info">Отправлен</span>
                          </td>
                          <td>
                            <button className="btn btn-ghost btn-xs">
                              Детали
                    ...
                    <tbody>
                      {products.map((product) => (
                        <tr key={product.id}>
                          ...
                          <td>€{product.price}</td>
                          <td
                            className={product.stock === 0 ? 'text-error' : ''}
                          >
                            {product.stock}
                          </td>
                          <td>{product.sold}</td>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div className="text-center">
                      <div
                        ...
                        style={{ '--value': 68, '--size': '8rem' } as any}
                      >
                        68%
                      </div>
                    ...
                    <div className="text-center">
                      <div
                        ...
                        style={{ '--value': 32, '--size': '8rem' } as any}
                      >
                        32%
                      </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        rows={3}
                        defaultValue="Лучшая электроника по доступным ценам"
                      />
                    </div>
                    <div>
                      <label className="label">
                      ...
                      <input
                        type="email"
                        className="input input-bordered w-full"
                        defaultValue="info@techstore.rs"
                      />
                    </div>
                    <div>
                      <label className="label">
                ...
                <div className="card bg-warning/20 border border-warning">
                  <div className="card-body">
                    ...
                    <p className="text-sm mb-4">
                      Разблокируйте дополнительные возможности для вашего
                      бизнеса
                    </p>
