        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-base-content/70 max-w-2xl mx-auto">
              Найдите свой заказ по номеру заказа или трек-номеру службы
              доставки и отследите статус доставки в реальном времени
            </p>
          </div>
          ...
          {!orders.length && !loading && !error && !searchQuery && (
            <div className="text-center py-12">
              ...
              <p className="text-base-content/60 max-w-md mx-auto">
                Введите номер заказа или трек-номер службы доставки для
                получения информации о статусе доставки
              </p>
            </div>
          )}
