  ...
  useEffect(() => {
    ...
    const fetchOrder = async () => {
      try {
        ...
        const response = await apiClient.get(`/api/v1/marketplace/orders/${id}`);
      ...
      <div className="card bg-base-100 shadow-xl">
        <div className="card-body text-center">
          ...
          {order && (
            <div className="bg-base-200 rounded-lg p-4 mb-6 text-left">
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  <span>Товар:</span>
                  <span className="font-medium">{order.listing?.title || 'Не указано'}</span>
                </div>
                <div className="flex justify-between">
                  <span>Сумма:</span>
                  <span className="font-medium">
                    {order.item_price ? balanceService.formatAmount(order.item_price, 'RSD') : 'Не указано'}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>Статус:</span>
          ...
          <div className="alert alert-info mb-6">
            ...
            <div>
              ...
              <p className="text-sm mt-1">
                Продавец получил уведомление о вашем заказе и свяжется с вами для согласования деталей доставки.
                Вы можете отслеживать статус заказа в разделе "Мои покупки".
              </p>
            </div>
          </div>
          ...
          <div className="card-actions justify-center space-x-4">
            <Link href={`/${locale}/profile/orders`} className="btn btn-primary">
              Мои заказы
            </Link>
