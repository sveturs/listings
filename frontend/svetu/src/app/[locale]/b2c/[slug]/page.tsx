...
import B2CStoreHeader from '@/components/b2c/public/B2CStoreHeader';
import B2CStoreInfo from '@/components/b2c/public/B2CStoreInfo';
import B2CStoreActions from '@/components/b2c/public/B2CStoreActions';
import B2CProducts from '@/components/b2c/public/B2CProducts';

// Dynamic import for map to avoid SSR issues
const B2CStoreLocationMap = dynamic(
  () => import('@/components/b2c/public/B2CStoreLocationMap'),
  { ssr: false }
);
...
export default function StorefrontPage({ params }: Props) {
  ...
  const { user } = useAuth();
  const [storefront, setStorefront] = useState<B2CStore | null>(null);
    ...
    return (
      <div className="min-h-screen bg-base-100 flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href={`/${locale}/b2c`} className="btn btn-primary">
            {t('browseStorefronts')}
          </Link>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {/* Products Section */}
            <B2CProducts storefrontSlug={slug} />
          ...
          <div className="space-y-6">
            {/* Store Info Card */}
            <B2CStoreInfo storefront={storefront} />

            {/* Actions Card */}
            <B2CStoreActions storefront={storefront} isOwner={isOwner} />
