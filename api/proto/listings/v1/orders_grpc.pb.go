...
func (UnimplementedOrderServiceServer) GetUserCarts(context.Context, *GetUserCartsRequest) (*GetUserCartsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GetUserCarts not implemented")
}
...
func (UnimplementedOrderServiceServer) CreateOrderShipment(context.Context, *CreateOrderShipmentRequest) (*CreateOrderShipmentResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method CreateOrderShipment not implemented")
}
func (UnimplementedOrderServiceServer) MarkOrderShipped(context.Context, *MarkOrderShippedRequest) (*MarkOrderShippedResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method MarkOrderShipped not implemented")
}
