...
SELECT pg_catalog.setval('public.category_ai_mappings_id_seq', 335, true);
...
SELECT pg_catalog.setval('public.category_detection_feedback_id_seq', 256, true);
...
SELECT pg_catalog.setval('public.global_product_id_seq', 317, true);
...
SELECT pg_catalog.setval('public.listing_attribute_values_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.marketplace_images_id_seq', 680, true);
...
SELECT pg_catalog.setval('public.price_history_id_seq', 183, true);
