...
ALTER TABLE ONLY public.storefront_category_mappings
    ADD CONSTRAINT storefront_category_mappings_pkey PRIMARY KEY (id);
...
ALTER TABLE ONLY public.storefront_category_mappings
    ADD CONSTRAINT uq_storefront_category_mapping UNIQUE (storefront_id, source_category_path);
