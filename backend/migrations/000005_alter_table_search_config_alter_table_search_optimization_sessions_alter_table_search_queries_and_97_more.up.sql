...
CREATE INDEX idx_bex_municipalities_active ON public.bex_municipalities USING btree (is_active) WHERE (is_active = true);
CREATE INDEX idx_bex_municipalities_bex_id ON public.bex_municipalities USING btree (bex_id);
CREATE INDEX idx_bex_municipalities_name ON public.bex_municipalities USING btree (name);
CREATE INDEX idx_bex_municipalities_name_cyrillic ON public.bex_municipalities USING btree (name_cyrillic);
CREATE INDEX idx_bex_parcel_shops_active ON public.bex_parcel_shops USING btree (is_active) WHERE (is_active = true);
CREATE INDEX idx_bex_parcel_shops_bex_id ON public.bex_parcel_shops USING btree (bex_id);
CREATE INDEX idx_bex_parcel_shops_city ON public.bex_parcel_shops USING btree (city);
CREATE INDEX idx_bex_places_active ON public.bex_places USING btree (is_active) WHERE (is_active = true);
CREATE INDEX idx_bex_places_bex_id ON public.bex_places USING btree (bex_id);
CREATE INDEX idx_bex_places_municipality_id ON public.bex_places USING btree (municipality_id);
CREATE INDEX idx_bex_places_name ON public.bex_places USING btree (name);
CREATE INDEX idx_bex_places_name_cyrillic ON public.bex_places USING btree (name_cyrillic);
CREATE INDEX idx_bex_places_name_cyrillic_trgm ON public.bex_places USING gin (name_cyrillic public.gin_trgm_ops);
CREATE INDEX idx_bex_places_name_trgm ON public.bex_places USING gin (name public.gin_trgm_ops);
