...
SELECT pg_catalog.setval('public.storefront_category_mappings_id_seq', 6, true);
...
SELECT pg_catalog.setval('public.storefront_order_items_id_seq', 20, true);
SELECT pg_catalog.setval('public.storefront_orders_id_seq', 59, true);
...
SELECT pg_catalog.setval('public.storefront_product_images_id_seq', 178, true);
SELECT pg_catalog.setval('public.storefront_product_variant_images_id_seq', 1, false);
SELECT pg_catalog.setval('public.storefront_product_variants_id_seq', 106, true);
...
SELECT pg_catalog.setval('public.unified_attribute_values_id_seq', 39, true);
SELECT pg_catalog.setval('public.unified_attributes_id_seq', 371, true);
SELECT pg_catalog.setval('public.unified_category_attributes_id_seq', 2330, true);
SELECT pg_catalog.setval('public.unified_geo_id_seq', 1782, true);
