...
END;
$$;
CREATE FUNCTION public.set_storefront_listing_needs_reindex() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
DECLARE
...
END;
$$;
CREATE TABLE public.b2c_favorites (
...
CREATE TABLE public.user_b2c_stores (
    id integer NOT NULL,
    user_id integer NOT NULL,
    name character varying(255) NOT NULL,
    description text,
...
CREATE TABLE public.b2c_delivery_options (
    id integer NOT NULL,
...
CREATE TABLE public.b2c_inventory_movements (
    id integer NOT NULL,
...
CREATE TABLE public.b2c_payment_methods (
    id integer NOT NULL,
    storefront_id integer NOT NULL,
...
CREATE TABLE public.b2c_product_attributes (
    id integer NOT NULL,
    product_id integer NOT NULL,
    attribute_id integer NOT NULL,
...
CREATE TABLE public.b2c_product_variant_images (
    id integer NOT NULL,
...
CREATE TABLE public.b2c_product_variants (
    id integer NOT NULL,
    product_id integer NOT NULL,
...
CREATE TABLE public.b2c_store_hours (
    id integer NOT NULL,
    storefront_id integer NOT NULL,
...
CREATE TABLE public.b2c_store_staff (
    id integer NOT NULL,
    storefront_id integer NOT NULL,
    user_id integer NOT NULL,
...
CREATE TABLE public.b2c_stores (
    id integer NOT NULL,
    user_id integer NOT NULL,
...
CREATE TABLE public.c2c_images (
    id integer NOT NULL,
    listing_id integer,
...
CREATE TABLE public.c2c_listing_variants (
    id integer NOT NULL,
    listing_id integer NOT NULL,
