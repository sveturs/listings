...
SELECT pg_catalog.setval('public.ai_category_decisions_id_seq', 72, true);
...
SELECT pg_catalog.setval('public.category_detection_feedback_id_seq', 313, true);
...
SELECT pg_catalog.setval('public.global_product_id_seq', 348, true);
...
SELECT pg_catalog.setval('public.marketplace_chats_id_seq', 22, true);
...
SELECT pg_catalog.setval('public.marketplace_messages_id_seq', 82, true);
...
SELECT pg_catalog.setval('public.search_queries_id_seq', 348, true);
