...
ALTER TABLE ONLY public.bex_places
    ADD CONSTRAINT bex_places_municipality_id_fkey FOREIGN KEY (municipality_id) REFERENCES public.bex_municipalities(id) ON DELETE CASCADE;
ALTER TABLE ONLY public.bex_shipments
    ADD CONSTRAINT bex_shipments_marketplace_order_id_fkey FOREIGN KEY (marketplace_order_id) REFERENCES public.marketplace_orders(id) ON DELETE SET NULL;
ALTER TABLE ONLY public.bex_shipments
    ADD CONSTRAINT bex_shipments_storefront_order_id_fkey FOREIGN KEY (storefront_order_id) REFERENCES public.storefront_orders(id) ON DELETE SET NULL;
