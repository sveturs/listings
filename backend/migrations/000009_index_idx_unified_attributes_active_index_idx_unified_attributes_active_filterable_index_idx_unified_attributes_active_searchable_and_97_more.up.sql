...
SELECT pg_catalog.setval('public.global_product_id_seq', 314, true);
...
SELECT pg_catalog.setval('public.listing_attribute_values_id_seq', 1, true);
...
SELECT pg_catalog.setval('public.marketplace_images_id_seq', 675, true);
