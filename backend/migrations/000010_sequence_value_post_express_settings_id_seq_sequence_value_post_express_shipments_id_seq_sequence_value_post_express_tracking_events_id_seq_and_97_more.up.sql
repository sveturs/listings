...
SELECT pg_catalog.setval('public.price_history_id_seq', 168, true);
...
SELECT pg_catalog.setval('public.shopping_carts_id_seq', 19, true);
SELECT pg_catalog.setval('public.storefront_delivery_options_id_seq', 1, true);
SELECT pg_catalog.setval('public.storefront_hours_id_seq', 50, true);
...
SELECT pg_catalog.setval('public.storefront_payment_methods_id_seq', 30, true);
...
SELECT pg_catalog.setval('public.storefront_staff_id_seq', 18, true);
SELECT pg_catalog.setval('public.storefronts_id_seq', 38, true);
...
SELECT pg_catalog.setval('public.unified_geo_id_seq', 440, true);
