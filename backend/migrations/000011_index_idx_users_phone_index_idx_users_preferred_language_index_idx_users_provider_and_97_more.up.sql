...
SELECT pg_catalog.setval('public.ai_category_decisions_id_seq', 16, true);
...
SELECT pg_catalog.setval('public.category_ai_mappings_id_seq', 383, true);
...
SELECT pg_catalog.setval('public.category_detection_feedback_id_seq', 282, true);
SELECT pg_catalog.setval('public.category_keyword_weights_id_seq', 139, true);
SELECT pg_catalog.setval('public.category_keywords_id_seq', 1021, true);
...
SELECT pg_catalog.setval('public.global_product_id_seq', 327, true);
...
SELECT pg_catalog.setval('public.listing_attribute_values_id_seq', 11, true);
...
SELECT pg_catalog.setval('public.marketplace_images_id_seq', 691, true);
...
SELECT pg_catalog.setval('public.price_history_id_seq', 193, true);
