...
SELECT pg_catalog.setval('public.translations_id_seq', 5065, true);
...
SELECT pg_catalog.setval('public.unified_geo_id_seq', 497, true);
SELECT pg_catalog.setval('public.user_behavior_events_id_seq', 2691, true);
