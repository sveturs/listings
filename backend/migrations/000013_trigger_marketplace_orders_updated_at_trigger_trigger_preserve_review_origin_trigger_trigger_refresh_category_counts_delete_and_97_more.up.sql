...
CREATE TRIGGER track_warehouse_inventory_changes AFTER UPDATE ON public.warehouse_inventory FOR EACH ROW EXECUTE FUNCTION public.track_inventory_changes();
...
CREATE TRIGGER trigger_update_failed_webhooks_updated_at BEFORE UPDATE ON public.failed_webhooks FOR EACH ROW EXECUTE FUNCTION public.update_failed_webhooks_updated_at();
...
CREATE TRIGGER update_bex_municipalities_updated_at BEFORE UPDATE ON public.bex_municipalities FOR EACH ROW EXECUTE FUNCTION public.update_bex_updated_at();
CREATE TRIGGER update_bex_parcel_shops_updated_at BEFORE UPDATE ON public.bex_parcel_shops FOR EACH ROW EXECUTE FUNCTION public.update_bex_updated_at();
CREATE TRIGGER update_bex_places_updated_at BEFORE UPDATE ON public.bex_places FOR EACH ROW EXECUTE FUNCTION public.update_bex_updated_at();
CREATE TRIGGER update_bex_rates_updated_at BEFORE UPDATE ON public.bex_rates FOR EACH ROW EXECUTE FUNCTION public.update_bex_updated_at();
CREATE TRIGGER update_bex_settings_updated_at BEFORE UPDATE ON public.bex_settings FOR EACH ROW EXECUTE FUNCTION public.update_bex_updated_at();
...
CREATE TRIGGER update_bex_streets_updated_at BEFORE UPDATE ON public.bex_streets FOR EACH ROW EXECUTE FUNCTION public.update_bex_updated_at();
...
CREATE TRIGGER update_post_express_locations_updated_at BEFORE UPDATE ON public.post_express_locations FOR EACH ROW EXECUTE FUNCTION public.update_post_express_updated_at();
CREATE TRIGGER update_post_express_offices_updated_at BEFORE UPDATE ON public.post_express_offices FOR EACH ROW EXECUTE FUNCTION public.update_post_express_updated_at();
CREATE TRIGGER update_post_express_rates_updated_at BEFORE UPDATE ON public.post_express_rates FOR EACH ROW EXECUTE FUNCTION public.update_post_express_updated_at();
CREATE TRIGGER update_post_express_settings_updated_at BEFORE UPDATE ON public.post_express_settings FOR EACH ROW EXECUTE FUNCTION public.update_post_express_updated_at();
CREATE TRIGGER update_post_express_shipments_updated_at BEFORE UPDATE ON public.post_express_shipments FOR EACH ROW EXECUTE FUNCTION public.update_post_express_updated_at();
...
CREATE TRIGGER update_storefront_fbs_settings_updated_at BEFORE UPDATE ON public.storefront_fbs_settings FOR EACH ROW EXECUTE FUNCTION public.update_warehouse_updated_at();
...
CREATE TRIGGER update_variant_attribute_mappings_updated_at BEFORE UPDATE ON public.variant_attribute_mappings FOR EACH ROW EXECUTE FUNCTION public.update_updated_at_column();
CREATE TRIGGER update_warehouse_inventory_updated_at BEFORE UPDATE ON public.warehouse_inventory FOR EACH ROW EXECUTE FUNCTION public.update_warehouse_updated_at();
CREATE TRIGGER update_warehouse_invoices_updated_at BEFORE UPDATE ON public.warehouse_invoices FOR EACH ROW EXECUTE FUNCTION public.update_warehouse_updated_at();
CREATE TRIGGER update_warehouse_pickup_orders_updated_at BEFORE UPDATE ON public.warehouse_pickup_orders FOR EACH ROW EXECUTE FUNCTION public.update_warehouse_updated_at();
CREATE TRIGGER update_warehouses_updated_at BEFORE UPDATE ON public.warehouses FOR EACH ROW EXECUTE FUNCTION public.update_warehouse_updated_at();
...
ALTER SEQUENCE public.bex_municipalities_id_seq OWNED BY public.bex_municipalities.id;
ALTER SEQUENCE public.bex_parcel_shops_id_seq OWNED BY public.bex_parcel_shops.id;
ALTER SEQUENCE public.bex_places_id_seq OWNED BY public.bex_places.id;
ALTER SEQUENCE public.bex_rates_id_seq OWNED BY public.bex_rates.id;
ALTER SEQUENCE public.bex_settings_id_seq OWNED BY public.bex_settings.id;
ALTER SEQUENCE public.bex_shipments_id_seq OWNED BY public.bex_shipments.id;
ALTER SEQUENCE public.bex_streets_id_seq OWNED BY public.bex_streets.id;
