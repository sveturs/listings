...
CREATE INDEX idx_import_jobs_created ON public.import_jobs USING btree (created_at DESC);
CREATE INDEX idx_import_jobs_status ON public.import_jobs USING btree (status);
CREATE INDEX idx_import_jobs_storefront ON public.import_jobs USING btree (storefront_id);
