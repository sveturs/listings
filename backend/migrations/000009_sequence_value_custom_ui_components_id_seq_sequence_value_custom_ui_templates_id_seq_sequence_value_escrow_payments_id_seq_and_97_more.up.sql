...
SELECT pg_catalog.setval('public.global_product_id_seq', 287, true);
...
SELECT pg_catalog.setval('public.price_history_id_seq', 164, true);
...
SELECT pg_catalog.setval('public.refresh_tokens_id_seq', 5264, true);
...
SELECT pg_catalog.setval('public.storefronts_id_seq', 35, true);
...
SELECT pg_catalog.setval('public.translations_id_seq', 4282, true);
...
SELECT pg_catalog.setval('public.user_behavior_events_id_seq', 925, true);
