...
SELECT pg_catalog.setval('public.global_product_id_seq', 293, true);
...
SELECT pg_catalog.setval('public.marketplace_images_id_seq', 664, true);
...
SELECT pg_catalog.setval('public.price_history_id_seq', 165, true);
...
SELECT pg_catalog.setval('public.refresh_tokens_id_seq', 5281, true);
...
SELECT pg_catalog.setval('public.search_queries_id_seq', 215, true);
...
SELECT pg_catalog.setval('public.translations_id_seq', 4306, true);
SELECT pg_catalog.setval('public.transliteration_rules_id_seq', 52, false);
SELECT pg_catalog.setval('public.unified_geo_id_seq', 377, true);
SELECT pg_catalog.setval('public.user_behavior_events_id_seq', 1534, true);
