...
SELECT pg_catalog.setval('public.global_product_id_seq', 269, true);
...
SELECT pg_catalog.setval('public.marketplace_images_id_seq', 404, true);
...
SELECT pg_catalog.setval('public.price_history_id_seq', 134, true);
...
SELECT pg_catalog.setval('public.refresh_tokens_id_seq', 5247, true);
...
SELECT pg_catalog.setval('public.search_queries_id_seq', 148, true);
...
SELECT pg_catalog.setval('public.storefront_hours_id_seq', 40, true);
...
SELECT pg_catalog.setval('public.storefront_payment_methods_id_seq', 24, true);
SELECT pg_catalog.setval('public.storefront_product_attributes_id_seq', 1, true);
SELECT pg_catalog.setval('public.storefront_product_images_id_seq', 65, true);
...
SELECT pg_catalog.setval('public.storefront_staff_id_seq', 16, true);
SELECT pg_catalog.setval('public.storefronts_id_seq', 34, true);
...
SELECT pg_catalog.setval('public.translations_id_seq', 3549, true);
SELECT pg_catalog.setval('public.transliteration_rules_id_seq', 52, false);
SELECT pg_catalog.setval('public.unified_geo_id_seq', 342, true);
SELECT pg_catalog.setval('public.user_behavior_events_id_seq', 924, true);
