...
CREATE INDEX idx_post_express_api_logs_created ON public.post_express_api_logs USING btree (created_at);
CREATE INDEX idx_post_express_api_logs_shipment ON public.post_express_api_logs USING btree (shipment_id);
...
CREATE INDEX idx_post_express_offices_active ON public.post_express_offices USING btree (is_active);
CREATE INDEX idx_post_express_shipments_created ON public.post_express_shipments USING btree (created_at);
CREATE INDEX idx_post_express_shipments_marketplace_order ON public.post_express_shipments USING btree (marketplace_order_id);
CREATE INDEX idx_post_express_shipments_status ON public.post_express_shipments USING btree (status);
CREATE INDEX idx_post_express_shipments_storefront_order ON public.post_express_shipments USING btree (storefront_order_id);
CREATE INDEX idx_post_express_shipments_tracking ON public.post_express_shipments USING btree (tracking_number);
CREATE INDEX idx_post_express_tracking_events_shipment ON public.post_express_tracking_events USING btree (shipment_id);
...
CREATE INDEX idx_storefront_orders_delivery_provider ON public.storefront_orders USING btree (delivery_provider);
CREATE INDEX idx_storefront_orders_delivery_tracking ON public.storefront_orders USING btree (delivery_tracking_number);
