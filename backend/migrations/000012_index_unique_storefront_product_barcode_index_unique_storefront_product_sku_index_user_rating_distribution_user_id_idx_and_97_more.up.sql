...
SELECT pg_catalog.setval('public.ai_category_decisions_id_seq', 56, true);
...
SELECT pg_catalog.setval('public.category_detection_feedback_id_seq', 299, true);
...
SELECT pg_catalog.setval('public.global_product_id_seq', 335, true);
...
SELECT pg_catalog.setval('public.listing_attribute_values_id_seq', 55, true);
...
SELECT pg_catalog.setval('public.marketplace_images_id_seq', 700, true);
...
SELECT pg_catalog.setval('public.price_history_id_seq', 198, true);
...
SELECT pg_catalog.setval('public.search_queries_id_seq', 338, true);
