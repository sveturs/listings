...
CREATE FUNCTION public.calculate_blurred_location(original_lat numeric, original_lng numeric, privacy_level public.location_privacy_level) RETURNS public.geography
    LANGUAGE plpgsql
    AS $$
DECLARE
    blur_radius INTEGER;
