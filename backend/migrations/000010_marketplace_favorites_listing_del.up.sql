...
('category', 1000, 'ru', 'name', 'Недвижимость', true, true, NOW(), NOW()),
...
('category', 3000, 'ru', 'name', 'Электроника', true, true, NOW(), NOW()),
    ...
    ('category', 3100, 'ru', 'name', 'Телефоны', true, true, NOW(), NOW()),
        ...
        ('category', 3120, 'ru', 'name', 'Аксессуары', true, true, NOW(), NOW()),
            ...
            ('category', 3121, 'ru', 'name', 'Аккумуляторы', true, true, NOW(), NOW()),
...
('category', 7000, 'ru', 'name', 'Хобби и отдых', true, true, NOW(), NOW()),
    ...
    ('category', 7250, 'ru', 'name', 'Коллекционирование', true, true, NOW(), NOW()),
        ...
        ('category', 7255, 'ru', 'name', 'Грампластинки', true, true, NOW(), NOW()),
    ...
    ('category', 7865, 'ru', 'name', 'Народное ремесло и рукоделие', true, true, NOW(), NOW()),
        -- Подкатегории народных ремесел (родитель id=7850)
        ('category', 7866, 'ru', 'name', 'Опанци', true, true, NOW(), NOW()),
        ('category', 7867, 'ru', 'name', 'Керамика', true, true, NOW(), NOW()),
        ('category', 7868, 'ru', 'name', 'Вышивка', true, true, NOW(), NOW()),
        ('category', 7869, 'ru', 'name', 'Ткачество', true, true, NOW(), NOW()),
        ('category', 7870, 'ru', 'name', 'Народные инструменты', true, true, NOW(), NOW()),
        ('category', 7871, 'ru', 'name', 'Деревообработка', true, true, NOW(), NOW()),
