...
CREATE SEQUENCE public.balance_transactions_id_seq
    ...
    NO MAXVALUE
    CACHE 1;
CREATE SEQUENCE public.bex_municipalities_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
    CACHE 1;
CREATE SEQUENCE public.bex_parcel_shops_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
    CACHE 1;
CREATE SEQUENCE public.bex_places_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
    CACHE 1;
CREATE SEQUENCE public.bex_rates_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
    CACHE 1;
CREATE SEQUENCE public.bex_settings_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE public.bex_shipments_id_seq
    ...
    NO MAXVALUE
    CACHE 1;
CREATE SEQUENCE public.bex_streets_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE public.permissions_id_seq
    ...
    NO MAXVALUE
    CACHE 1;
CREATE SEQUENCE public.post_express_api_logs_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
CREATE SEQUENCE public.storefront_delivery_options_id_seq
    ...
    NO MAXVALUE
    CACHE 1;
CREATE SEQUENCE public.storefront_fbs_settings_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
