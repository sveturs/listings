...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=models.GeoLocation} "Адрес по координатам"
...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=[]models.GeoLocation} "Список городов"
