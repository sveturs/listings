...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=models.Review} "Created draft review"
...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=models.Review} "Published review"
...
// @Produce json
// @Param id path int true "Review ID"
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=models.Review} "Review details"
// @Failure 400 {object} backend_pkg_utils.ErrorResponseSwag "Invalid review ID"
// @Failure 500 {object} backend_pkg_utils.ErrorResponseSwag "Internal server error"
...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=models.ReviewStats} "Review statistics"
// @Failure 500 {object} backend_pkg_utils.ErrorResponseSwag "Internal server error"
...
// @Param type path string true "Entity type"
// @Param id path int true "Entity ID"
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=models.ReviewStats} "Entity review statistics"
// @Failure 400 {object} backend_pkg_utils.ErrorResponseSwag "Invalid entity ID"
// @Failure 500 {object} backend_pkg_utils.ErrorResponseSwag "Internal server error"
...
// @Produce json
// @Param id path int true "User ID"
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=models.UserRatingSummary} "User rating summary"
// @Failure 400 {object} backend_pkg_utils.ErrorResponseSwag "Invalid user ID"
// @Failure 500 {object} backend_pkg_utils.ErrorResponseSwag "Internal server error"
...
// @Produce json
// @Param id path int true "Storefront ID"
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=models.StorefrontRatingSummary} "Storefront rating summary"
// @Failure 400 {object} backend_pkg_utils.ErrorResponseSwag "Invalid storefront ID"
// @Failure 500 {object} backend_pkg_utils.ErrorResponseSwag "Internal server error"
...
// @Produce json
// @Param id path int true "User ID"
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=models.AggregatedRating} "Aggregated rating"
// @Failure 400 {object} backend_pkg_utils.ErrorResponseSwag "Invalid user ID"
// @Failure 500 {object} backend_pkg_utils.ErrorResponseSwag "Internal server error"
...
// @Param id path int true "Entity ID"
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=models.CanReviewResponse} "Permission check result"
