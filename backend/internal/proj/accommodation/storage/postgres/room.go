// backend/internal/proj/accommodation/storage/postgres/room.go
package postgres
...
func (s *Storage) GetRooms(ctx context.Context, filters map[string]string, sortBy, sortDirection string, limit, offset int) ([]models.Room, int64, error) {
