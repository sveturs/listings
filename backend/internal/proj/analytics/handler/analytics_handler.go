...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=service.SearchMetrics} "Search metrics"
...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=[]service.ItemPerformance} "Items performance"
// @Failure 401 {object} backend_pkg_utils.ErrorResponseSwag "Unauthorized"
// @Failure 500 {object} backend_pkg_utils.ErrorResponseSwag "Internal server error"
