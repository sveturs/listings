...
// @Success 200 {object} utils.SuccessResponseSwag{data=backend_internal_proj_analytics_service.SearchMetrics} "Search metrics"
...
// @Success 200 {object} utils.SuccessResponseSwag{data=[]backend_internal_proj_analytics_service.ItemPerformance} "Items performance"
// @Failure 401 {object} utils.ErrorResponseSwag "Unauthorized"
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
