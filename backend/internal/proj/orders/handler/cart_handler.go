...
// @Param item body backend_internal_domain_models.AddToCartRequest true "Item to add"
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=backend_internal_domain_models.ShoppingCart} "Updated cart"
...
// @Param update body backend_internal_domain_models.UpdateCartItemRequest true "Updated quantity"
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=backend_internal_domain_models.ShoppingCart} "Updated cart"
// @Failure 400 {object} backend_pkg_utils.ErrorResponseSwag "Bad request"
// @Failure 401 {object} backend_pkg_utils.ErrorResponseSwag "Unauthorized"
...
// @Produce json
// @Param storefront_id path int true "Storefront ID"
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=backend_internal_domain_models.ShoppingCart} "Cart contents"
// @Failure 400 {object} backend_pkg_utils.ErrorResponseSwag "Bad request"
// @Failure 401 {object} backend_pkg_utils.ErrorResponseSwag "Unauthorized"
// @Failure 500 {object} backend_pkg_utils.ErrorResponseSwag "Internal server error"
// @Security BearerAuth
...
// @Tags cart
// @Produce json
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=[]backend_internal_domain_models.ShoppingCart} "User's carts"
// @Failure 401 {object} backend_pkg_utils.ErrorResponseSwag "Unauthorized"
// @Failure 500 {object} backend_pkg_utils.ErrorResponseSwag "Internal server error"
// @Security BearerAuth
