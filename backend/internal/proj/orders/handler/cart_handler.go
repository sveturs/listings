...
// @Security BearerAuth
// @Router /api/v1/marketplace/storefronts/{storefront_id}/cart/items [post]
...
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Security BearerAuth
// @Router /api/v1/marketplace/storefronts/{storefront_id}/cart/items/{item_id} [put]
...
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Security BearerAuth
// @Router /api/v1/marketplace/storefronts/{storefront_id}/cart/items/{item_id} [delete]
...
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Security BearerAuth
// @Router /api/v1/marketplace/storefronts/{storefront_id}/cart [get]
...
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Security BearerAuth
// @Router /api/v1/marketplace/storefronts/{storefront_id}/cart [delete]
