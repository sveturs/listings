...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=[]models.UnifiedAttribute} "List of category attributes"
...
// @Produce json
// @Param category_id path int true "Category ID"
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=[]models.UnifiedCategoryAttribute} "List of category attributes with settings"
// @Failure 400 {object} backend_pkg_utils.ErrorResponseSwag "Invalid category ID"
// @Failure 500 {object} backend_pkg_utils.ErrorResponseSwag "Internal server error"
...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=[]models.UnifiedAttributeValue} "List of attribute values"
