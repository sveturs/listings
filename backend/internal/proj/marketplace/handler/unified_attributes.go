...
// @Success 200 {object} utils.SuccessResponseSwag{data=[]backend_internal_domain_models.UnifiedAttribute} "List of category attributes"
...
// @Produce json
// @Param category_id path int true "Category ID"
// @Success 200 {object} utils.SuccessResponseSwag{data=[]backend_internal_domain_models.UnifiedCategoryAttribute} "List of category attributes with settings"
// @Failure 400 {object} utils.ErrorResponseSwag "Invalid category ID"
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
...
// @Success 200 {object} utils.SuccessResponseSwag{data=[]backend_internal_domain_models.UnifiedAttributeValue} "List of attribute values"
