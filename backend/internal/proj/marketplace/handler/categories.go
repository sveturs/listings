...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=[]backend_internal_domain_models.MarketplaceCategory}
...
// @Produce json
// @Param lang query string false "Language code (e.g., 'sr', 'en', 'ru')"
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=[]backend_internal_domain_models.CategoryTreeNode}
...
// @Param lang query string false "Language code (e.g., 'sr', 'en', 'ru')"
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=[]backend_internal_domain_models.CategoryAttribute}
