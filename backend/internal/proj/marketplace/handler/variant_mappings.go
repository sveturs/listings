...
// @Accept json
// @Produce json
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=[]models.UnifiedAttribute} "List of variant compatible attributes"
...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=[]models.VariantAttributeMapping} "Category variant mappings"
...
// @Success 201 {object} backend_pkg_utils.SuccessResponseSwag{data=models.VariantAttributeMapping} "Created mapping"
