...
// @Accept json
// @Produce json
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=[]models.MarketplaceCategory} "Categories list"
...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=models.MarketplaceCategory} "Category information"
...
// @Produce json
// @Param id path int true "Category ID"
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=[]models.AttributeGroup} "Category groups"
// @Failure 400 {object} backend_pkg_utils.ErrorResponseSwag "marketplace.invalidCategoryId"
...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=[]models.CategoryKeyword} "Keywords list"
// @Failure 400 {object} backend_pkg_utils.ErrorResponseSwag "Invalid category ID"
// @Failure 404 {object} backend_pkg_utils.ErrorResponseSwag "Category not found"
...
// @Success 201 {object} backend_pkg_utils.SuccessResponseSwag{data=models.CategoryKeyword} "Created keyword"
...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=models.CategoryKeyword} "Updated keyword"
// @Failure 400 {object} backend_pkg_utils.ErrorResponseSwag "Invalid request data"
...
// @Produce json
// @Param id path int true "Category ID"
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=[]models.CategoryVariantAttribute} "Category variant attributes"
// @Failure 400 {object} backend_pkg_utils.ErrorResponseSwag "marketplace.invalidCategoryId"
