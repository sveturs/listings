...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=[]models.CarMake} "List of car makes"
...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=[]models.CarModel} "List of car models"
// @Failure 400 {object} backend_pkg_utils.ErrorResponseSwag "Bad request"
...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=[]models.CarGeneration} "List of car generations"
// @Failure 400 {object} backend_pkg_utils.ErrorResponseSwag "Bad request"
...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=[]models.CarMake} "Search results"
// @Failure 400 {object} backend_pkg_utils.ErrorResponseSwag "Bad request"
// @Failure 500 {object} backend_pkg_utils.ErrorResponseSwag "Internal server error"
...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=models.VINDecodeResult} "VIN decode result"
