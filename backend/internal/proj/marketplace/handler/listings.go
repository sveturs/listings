...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=models.MarketplaceListing} "Listing details"
...
// @Produce json
// @Param id path int true "Listing ID"
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=[]models.PriceHistoryEntry} "Price history entries"
// @Failure 400 {object} backend_pkg_utils.ErrorResponseSwag "marketplace.invalidId"
