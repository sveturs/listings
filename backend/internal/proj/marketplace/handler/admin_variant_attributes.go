...
// @Success 200 {object} utils.SuccessResponseSwag{data=[]backend_internal_domain_models.ProductVariantAttribute} "Variant attributes list"
...
// @Success 201 {object} utils.SuccessResponseSwag{data=backend_internal_domain_models.ProductVariantAttribute} "marketplace.variantAttributeCreated"
...
// @Success 200 {object} utils.SuccessResponseSwag{data=backend_internal_domain_models.ProductVariantAttribute} "marketplace.variantAttributeUpdated"
...
// @Produce json
// @Param id path int true "Variant attribute ID"
// @Success 200 {object} utils.SuccessResponseSwag{data=backend_internal_domain_models.ProductVariantAttribute} "Variant attribute details"
// @Failure 400 {object} utils.ErrorResponseSwag "marketplace.invalidID"
// @Failure 404 {object} utils.ErrorResponseSwag "marketplace.variantAttributeNotFound"
