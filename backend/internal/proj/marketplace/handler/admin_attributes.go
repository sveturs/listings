...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=models.PaginatedResponse} "Paginated list of attributes"
...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=models.CategoryAttribute} "Attribute information"
...
// @Produce json
// @Param categoryId path int true "Category ID"
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=[]models.CategoryAttributeMapping} "Category attributes with settings"
