...
// @Success 200 {object} utils.SuccessResponseSwag{data=backend_internal_domain_models.UserBalance} "User balance"
...
// @Success 200 {object} utils.SuccessResponseSwag{data=[]backend_internal_domain_models.BalanceTransaction} "Transaction history"
// @Failure 400 {object} utils.ErrorResponseSwag "admin.balance.error.invalid_user_id"
