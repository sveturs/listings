...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=models.UserBalance} "User balance"
...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=[]models.BalanceTransaction} "Transaction history"
// @Failure 400 {object} backend_pkg_utils.ErrorResponseSwag "admin.balance.error.invalid_user_id"
