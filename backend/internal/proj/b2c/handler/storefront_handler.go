...
func (h *StorefrontHandler) CreateStorefront(c *fiber.Ctx) error {
	...
	if err != nil {
		...
		case errors.Is(err, service.ErrStorefrontLimitReached):
			return utils.ErrorResponse(c, fiber.StatusForbidden, "b2c_stores.error.limit_reached")
		case errors.Is(err, service.ErrInvalidLocation):
			return utils.ErrorResponse(c, fiber.StatusBadRequest, "b2c_stores.error.invalid_location")
		default:
			return utils.ErrorResponse(c, fiber.StatusInternalServerError, "b2c_stores.error.create_failed")
		}
	}
...
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Router /api/v1/b2c_stores/{id} [get]
func (h *StorefrontHandler) GetStorefront(c *fiber.Ctx) error {
	...
	if err != nil {
		if errors.Is(err, postgres.ErrNotFound) {
			return utils.ErrorResponse(c, fiber.StatusNotFound, "b2c_stores.error.not_found")
		}
		return utils.ErrorResponse(c, fiber.StatusInternalServerError, "b2c_stores.error.get_failed")
	}
...
// @Failure 404 {object} utils.ErrorResponseSwag "Storefront not found"
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Router /api/v1/b2c_stores/slug/{slug} [get]
...
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Security BearerAuth
// @Router /api/v1/b2c_stores/{id} [put]
func (h *StorefrontHandler) UpdateStorefront(c *fiber.Ctx) error {
	...
	if err != nil {
		...
		case errors.Is(err, service.ErrFeatureNotAvailable):
			return utils.ErrorResponse(c, fiber.StatusForbidden, "b2c_stores.error.feature_not_available")
		case errors.Is(err, postgres.ErrNotFound):
			return utils.ErrorResponse(c, fiber.StatusNotFound, "b2c_stores.error.not_found")
		default:
			return utils.ErrorResponse(c, fiber.StatusInternalServerError, "b2c_stores.error.update_failed")
		}
	}
...
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Security BearerAuth
// @Router /api/v1/b2c_stores/{id} [delete]
func (h *StorefrontHandler) DeleteStorefront(c *fiber.Ctx) error {
	...
	if err != nil {
		...
		case errors.Is(err, service.ErrUnauthorized):
			return utils.ErrorResponse(c, fiber.StatusForbidden, "b2c_stores.error.only_owner_can_delete")
		case errors.Is(err, postgres.ErrNotFound):
			return utils.ErrorResponse(c, fiber.StatusNotFound, "b2c_stores.error.not_found")
		default:
			return utils.ErrorResponse(c, fiber.StatusInternalServerError, "b2c_stores.error.delete_failed")
		}
	}
...
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Security BearerAuth
// @Router /api/v1/b2c_stores/{id}/restore [post]
func (h *StorefrontHandler) RestoreStorefront(c *fiber.Ctx) error {
	userID, _ := authMiddleware.GetUserID(c)
	isAdmin := authMiddleware.IsAdmin(c)

	if !isAdmin {
		return utils.ErrorResponse(c, fiber.StatusForbidden, "b2c_stores.error.admin_access_required")
	}
	...
	if err != nil {
		...
		default:
			...
			return utils.ErrorResponse(c, fiber.StatusInternalServerError, "b2c_stores.error.restore_failed")
		}
	}
...
// @Success 200 {object} StorefrontsListResponse "List of b2c_stores"
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Router /api/v1/b2c_stores [get]
func (h *StorefrontHandler) ListStorefronts(c *fiber.Ctx) error {
	...
	b2c_stores, total, err := h.service.Search(c.Context(), filter)
	if err != nil {
		logger.Error().Err(err).Msg("Failed to list b2c_stores")
		return utils.ErrorResponse(c, fiber.StatusInternalServerError, "b2c_stores.error.list_failed")
	}

	logger.Info().
		Int("total", total).
		Int("returned", len(b2c_stores)).
...
// @Accept json
// @Produce json
// @Success 200 {object} []models.Storefront "List of user's b2c_stores"
// @Failure 401 {object} utils.ErrorResponseSwag "Unauthorized"
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Security BearerAuth
// @Router /api/v1/b2c_stores/my [get]
func (h *StorefrontHandler) GetMyStorefronts(c *fiber.Ctx) error {
	logger.Info().Msg("GetMyStorefronts called")

	userID, _ := authMiddleware.GetUserID(c)
	logger.Info().Int("userID", userID).Msg("Getting b2c_stores for user")

	b2c_stores, err := h.service.ListUserStorefronts(c.Context(), userID)
	if err != nil {
		// Логируем конкретную ошибку
		logger.Error().Err(err).Int("userID", userID).Msg("Failed to get user b2c_stores")

		// Обрабатываем специфичные ошибки
		if errors.Is(err, service.ErrRepositoryNotInitialized) {
			return utils.ErrorResponse(c, fiber.StatusBadRequest, "b2c_stores.error.repository_not_initialized")
		}
		return utils.ErrorResponse(c, fiber.StatusInternalServerError, "b2c_stores.error.get_user_b2c_stores_failed")
	}

	return c.JSON(b2c_stores)
}
...
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Router /api/v1/b2c_stores/map [get]
func (h *StorefrontHandler) GetMapData(c *fiber.Ctx) error {
	...
	if err1 != nil || err2 != nil || err3 != nil || err4 != nil {
		return utils.ErrorResponse(c, fiber.StatusBadRequest, "b2c_stores.error.invalid_map_bounds")
	}
	...
	if err != nil {
		return utils.ErrorResponse(c, fiber.StatusInternalServerError, "b2c_stores.error.get_map_data_failed")
	}
...
// @Param is_verified query bool false "Only verified b2c_stores"
// @Param is_open_now query bool false "Only currently open b2c_stores"
...
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Router /api/v1/b2c_stores/search [get]
func (h *StorefrontHandler) SearchOpenSearch(c *fiber.Ctx) error {
	...
	if err != nil {
		return utils.ErrorResponse(c, fiber.StatusInternalServerError, "b2c_stores.error.search_failed")
	}
...
// @Success 200 {object} []models.Storefront "Nearby b2c_stores"
// @Failure 400 {object} utils.ErrorResponseSwag "Invalid coordinates"
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Router /api/v1/b2c_stores/nearby [get]
func (h *StorefrontHandler) GetNearbyStorefronts(c *fiber.Ctx) error {
	lat, err1 := strconv.ParseFloat(c.Query("lat"), 64)
	lng, err2 := strconv.ParseFloat(c.Query("lng"), 64)

	if err1 != nil || err2 != nil {
		return utils.ErrorResponse(c, fiber.StatusBadRequest, "b2c_stores.error.invalid_coordinates")
	}
	...
	b2c_stores, err := h.service.GetNearby(c.Context(), lat, lng, radiusKm, limit)
	if err != nil {
		return utils.ErrorResponse(c, fiber.StatusInternalServerError, "b2c_stores.error.get_nearby_failed")
	}
...
// @Failure 400 {object} utils.ErrorResponseSwag "Invalid coordinates"
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Router /api/v1/b2c_stores/building [get]
func (h *StorefrontHandler) GetBusinessesInBuilding(c *fiber.Ctx) error {
	...
	if err != nil {
		return utils.ErrorResponse(c, fiber.StatusInternalServerError, "b2c_stores.error.get_businesses_in_building_failed")
	}
...
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Security BearerAuth
// @Router /api/v1/b2c_stores/{id}/hours [put]
func (h *StorefrontHandler) UpdateWorkingHours(c *fiber.Ctx) error {
	...
	if err != nil {
		...
		return utils.ErrorResponse(c, fiber.StatusInternalServerError, "b2c_stores.error.update_working_hours_failed")
	}
...
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Security BearerAuth
// @Router /api/v1/b2c_stores/{id}/payment-methods [put]
func (h *StorefrontHandler) UpdatePaymentMethods(c *fiber.Ctx) error {
	...
	if err != nil {
		...
		return utils.ErrorResponse(c, fiber.StatusInternalServerError, "b2c_stores.error.update_payment_methods_failed")
	}
...
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Security BearerAuth
// @Router /api/v1/b2c_stores/{id}/delivery-options [put]
func (h *StorefrontHandler) UpdateDeliveryOptions(c *fiber.Ctx) error {
	...
	if err != nil {
		...
		return utils.ErrorResponse(c, fiber.StatusInternalServerError, "b2c_stores.error.update_delivery_options_failed")
	}
...
// @Failure 400 {object} utils.ErrorResponseSwag "Bad request"
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Router /api/v1/b2c_stores/{id}/view [post]
func (h *StorefrontHandler) RecordView(c *fiber.Ctx) error {
	...
	if err != nil {
		return utils.ErrorResponse(c, fiber.StatusInternalServerError, "b2c_stores.error.record_view_failed")
	}
...
func (h *StorefrontHandler) GetAnalytics(c *fiber.Ctx) error {
	...
	if err != nil {
		...
		if err != nil {
			return utils.ErrorResponse(c, fiber.StatusBadRequest, "b2c_stores.error.invalid_from_date")
		}
	}
	...
	if err != nil {
		...
		if err != nil {
			return utils.ErrorResponse(c, fiber.StatusBadRequest, "b2c_stores.error.invalid_to_date")
		}
	}
	...
	if err != nil {
		...
		return utils.ErrorResponse(c, fiber.StatusInternalServerError, "b2c_stores.error.get_analytics_failed")
	}
...
type StorefrontsListResponse struct {
	Storefronts []*models.Storefront `json:"b2c_stores"`
...
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Security BearerAuth
// @Router /api/v1/b2c_stores/{id}/logo [post]
func (h *StorefrontHandler) UploadLogo(c *fiber.Ctx) error {
	...
	if err != nil {
		return utils.ErrorResponse(c, fiber.StatusBadRequest, "b2c_stores.error.failed_to_get_logo_file")
	}

	// Читаем файл
	src, err := file.Open()
	if err != nil {
		return utils.ErrorResponse(c, fiber.StatusInternalServerError, "b2c_stores.error.failed_to_open_file")
	}
	defer func() {
	...
	if _, err := src.Read(data); err != nil {
		return utils.ErrorResponse(c, fiber.StatusInternalServerError, "b2c_stores.error.failed_to_read_file")
	}
	...
	if err != nil {
		...
		return utils.ErrorResponse(c, fiber.StatusInternalServerError, "b2c_stores.error.failed_to_upload_logo")
	}
...
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Security BearerAuth
// @Router /api/v1/b2c_stores/{id}/banner [post]
func (h *StorefrontHandler) UploadBanner(c *fiber.Ctx) error {
	...
	if err != nil {
		return utils.ErrorResponse(c, fiber.StatusBadRequest, "b2c_stores.error.failed_to_get_banner_file")
	}
	...
	if err != nil {
		...
		return utils.ErrorResponse(c, fiber.StatusInternalServerError, "b2c_stores.error.failed_to_upload_banner")
	}
...
func (h *StorefrontHandler) GetStorefrontAnalytics(c *fiber.Ctx) error {
	...
	if err != nil {
		...
		return utils.ErrorResponse(c, fiber.StatusInternalServerError, "b2c_stores.error.failed_to_get_analytics")
	}
