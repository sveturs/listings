...
// @Router /api/v1/b2c_stores/slug/{slug}/products/{product_id}/images [post]
func (h *ImageHandler) UploadProductImage(c *fiber.Ctx) error {
	...
	if err != nil {
		...
		return utils.ErrorResponse(c, http.StatusBadRequest, "b2c_stores.invalid_product_id")
	}
	...
	if err != nil {
		...
		return utils.ErrorResponse(c, http.StatusBadRequest, "b2c_stores.no_image_file")
	}
	...
	src, err := file.Open()
	if err != nil {
		return utils.ErrorResponse(c, http.StatusInternalServerError, "b2c_stores.file_open_error")
	}
	defer func() {
	...
	if err != nil {
		...
		return utils.ErrorResponse(c, http.StatusInternalServerError, "b2c_stores.upload_failed")
	}
...
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Router /api/v1/b2c_stores/slug/{slug}/products/{product_id}/images [get]
func (h *ImageHandler) GetProductImages(c *fiber.Ctx) error {
	...
	if err != nil {
		return utils.ErrorResponse(c, http.StatusInternalServerError, "b2c_stores.get_images_failed")
	}
...
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Router /api/v1/b2c_stores/slug/{slug}/products/{product_id}/images/{image_id} [delete]
func (h *ImageHandler) DeleteProductImage(c *fiber.Ctx) error {
	...
	if err != nil {
		return utils.ErrorResponse(c, http.StatusBadRequest, "b2c_stores.invalid_image_id")
	}

	// Удаление изображения
	err = h.imageService.DeleteImage(c.Context(), imageID, services.ImageTypeStorefrontProduct)
	if err != nil {
		return utils.ErrorResponse(c, http.StatusInternalServerError, "b2c_stores.delete_failed")
	}
...
// @Failure 404 {object} utils.ErrorResponseSwag "Image not found"
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Router /api/v1/b2c_stores/slug/{slug}/products/{product_id}/images/{image_id}/main [post]
func (h *ImageHandler) SetMainProductImage(c *fiber.Ctx) error {
	...
	if err != nil {
		return utils.ErrorResponse(c, http.StatusInternalServerError, "b2c_stores.set_main_failed")
	}
...
// @Failure 401 {object} utils.ErrorResponseSwag "Unauthorized"
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Router /api/v1/b2c_stores/slug/{slug}/products/{product_id}/images/order [put]
func (h *ImageHandler) UpdateImageOrder(c *fiber.Ctx) error {
	var updates []ImageOrderUpdate
	if err := c.BodyParser(&updates); err != nil {
		return utils.ErrorResponse(c, http.StatusBadRequest, "b2c_stores.invalid_request")
	}
	...
	for _, update := range updates {
		...
		if err != nil {
			return utils.ErrorResponse(c, http.StatusInternalServerError, "b2c_stores.update_order_failed")
		}
	}
