...
// @Security BearerAuth
// @Router /api/v1/b2c_stores/ai/analyze-product-image [post]
...
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Security BearerAuth
// @Router /api/v1/b2c_stores/ai/detect-category [post]
...
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Security BearerAuth
// @Router /api/v1/b2c_stores/ai/ab-test-titles [post]
...
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Security BearerAuth
// @Router /api/v1/b2c_stores/ai/translate-content [post]
...
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Security BearerAuth
// @Router /api/v1/b2c_stores/ai/metrics [get]
