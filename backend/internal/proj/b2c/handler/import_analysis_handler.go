...
// @Security BearerAuth
// @Router /api/v1/b2c_stores/{storefront_id}/import/analyze-categories [post]
...
// @Failure 500 {object} models.ErrorResponse "Internal server error"
// @Security BearerAuth
// @Router /api/v1/b2c_stores/{storefront_id}/import/analyze-attributes [post]
...
// @Failure 500 {object} models.ErrorResponse "Internal server error"
// @Security BearerAuth
// @Router /api/v1/b2c_stores/{storefront_id}/import/detect-variants [post]
...
// @Failure 500 {object} models.ErrorResponse "Internal server error"
// @Security BearerAuth
// @Router /api/v1/b2c_stores/{storefront_id}/import/analyze-client-categories [post]
