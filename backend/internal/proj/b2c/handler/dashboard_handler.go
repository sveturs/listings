...
// @Security BearerAuth
// @Router /api/v1/b2c_stores/{slug}/dashboard/stats [get]
func (h *DashboardHandler) GetDashboardStats(c *fiber.Ctx) error {
	...
	if storefront.UserID != userID {
		return utils.ErrorResponse(c, fiber.StatusForbidden, "b2c_stores.error.access_denied")
	}

	// Получаем реальную статистику из БД
	stats, err := h.repository.GetDashboardStats(c.Context(), storefront.ID)
	if err != nil {
		return utils.ErrorResponse(c, fiber.StatusInternalServerError, "b2c_stores.error.stats_failed")
	}
...
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Security BearerAuth
// @Router /api/v1/b2c_stores/{slug}/dashboard/recent-orders [get]
func (h *DashboardHandler) GetRecentOrders(c *fiber.Ctx) error {
	...
	if err != nil {
		return utils.ErrorResponse(c, fiber.StatusInternalServerError, "b2c_stores.error.orders_failed")
	}
...
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Security BearerAuth
// @Router /api/v1/b2c_stores/{slug}/dashboard/low-stock [get]
func (h *DashboardHandler) GetLowStockProducts(c *fiber.Ctx) error {
	...
	if err != nil {
		return utils.ErrorResponse(c, fiber.StatusInternalServerError, "b2c_stores.error.low_stock_failed")
	}
...
// @Failure 500 {object} utils.ErrorResponseSwag "Internal server error"
// @Security BearerAuth
// @Router /api/v1/b2c_stores/{slug}/dashboard/notifications [get]
