...
// @Failure 404 {object} backend_internal_proj_storefronts_models.ErrorResponse "Product not found"
// @Failure 500 {object} backend_internal_proj_storefronts_models.ErrorResponse "Internal server error"
...
// @Produce json
// @Param slug path string true "Storefront slug"
// @Param product body backend_internal_proj_storefronts_models.CreateProductRequest true "Product data with optional variants"
...
// @Param slug path string true "Storefront slug"
// @Param id path int true "Product ID"
// @Param product body backend_internal_proj_storefronts_models.UpdateProductRequest true "Product update data"
// @Success 200 {object} backend_internal_proj_storefronts_models.SuccessResponse "Product updated successfully"
// @Failure 400 {object} backend_internal_proj_storefronts_models.ErrorResponse "Bad request"
// @Failure 401 {object} backend_internal_proj_storefronts_models.ErrorResponse "Unauthorized"
// @Failure 404 {object} backend_internal_proj_storefronts_models.ErrorResponse "Product not found"
// @Failure 500 {object} backend_internal_proj_storefronts_models.ErrorResponse "Internal server error"
...
// @Param slug path string true "Storefront slug"
// @Param id path int true "Product ID"
// @Success 200 {object} backend_internal_proj_storefronts_models.SuccessResponse "Product deleted successfully"
// @Failure 400 {object} backend_internal_proj_storefronts_models.ErrorResponse "Bad request"
// @Failure 401 {object} backend_internal_proj_storefronts_models.ErrorResponse "Unauthorized"
// @Failure 404 {object} backend_internal_proj_storefronts_models.ErrorResponse "Product not found"
// @Failure 500 {object} backend_internal_proj_storefronts_models.ErrorResponse "Internal server error"
...
// @Param slug path string true "Storefront slug"
// @Param id path int true "Product ID"
// @Param inventory body backend_internal_proj_storefronts_models.UpdateInventoryRequest true "Inventory update data"
// @Success 200 {object} backend_internal_proj_storefronts_models.SuccessResponse "Inventory updated successfully"
// @Failure 400 {object} backend_internal_proj_storefronts_models.ErrorResponse "Bad request"
// @Failure 401 {object} backend_internal_proj_storefronts_models.ErrorResponse "Unauthorized"
// @Failure 404 {object} backend_internal_proj_storefronts_models.ErrorResponse "Product not found"
// @Failure 500 {object} backend_internal_proj_storefronts_models.ErrorResponse "Internal server error"
...
// @Produce json
// @Param slug path string true "Storefront slug"
// @Success 200 {object} backend_internal_proj_storefronts_models.ProductStats "Product statistics"
// @Failure 401 {object} backend_internal_proj_storefronts_models.ErrorResponse "Unauthorized"
// @Failure 500 {object} backend_internal_proj_storefronts_models.ErrorResponse "Internal server error"
// @Security BearerAuth
...
// @Param slug path string true "Storefront slug"
// @Param body body backend_internal_proj_storefronts_models.BulkCreateProductsRequest true "Products to create"
// @Success 200 {object} backend_internal_proj_storefronts_models.BulkCreateProductsResponse "Bulk creation result"
// @Failure 400 {object} backend_internal_proj_storefronts_models.ErrorResponse "Bad request"
// @Failure 401 {object} backend_internal_proj_storefronts_models.ErrorResponse "Unauthorized"
// @Failure 500 {object} backend_internal_proj_storefronts_models.ErrorResponse "Internal server error"
...
// @Param Authorization header string true "Bearer token"
// @Param slug path string true "Storefront slug"
// @Param body body backend_internal_proj_storefronts_models.BulkUpdateProductsRequest true "Products to update"
// @Success 200 {object} backend_internal_proj_storefronts_models.BulkUpdateProductsResponse "Bulk update result"
// @Failure 400 {object} backend_internal_proj_storefronts_models.ErrorResponse "Bad request"
// @Failure 401 {object} backend_internal_proj_storefronts_models.ErrorResponse "Unauthorized"
// @Failure 500 {object} backend_internal_proj_storefronts_models.ErrorResponse "Internal server error"
...
// @Param Authorization header string true "Bearer token"
// @Param slug path string true "Storefront slug"
// @Param body body backend_internal_proj_storefronts_models.BulkDeleteProductsRequest true "Product IDs to delete"
// @Success 200 {object} backend_internal_proj_storefronts_models.BulkDeleteProductsResponse "Bulk deletion result"
// @Failure 400 {object} backend_internal_proj_storefronts_models.ErrorResponse "Bad request"
// @Failure 401 {object} backend_internal_proj_storefronts_models.ErrorResponse "Unauthorized"
// @Failure 500 {object} backend_internal_proj_storefronts_models.ErrorResponse "Internal server error"
...
// @Param Authorization header string true "Bearer token"
// @Param slug path string true "Storefront slug"
// @Param body body backend_internal_proj_storefronts_models.BulkUpdateStatusRequest true "Product IDs and status"
// @Success 200 {object} backend_internal_proj_storefronts_models.BulkUpdateStatusResponse "Bulk status update result"
// @Failure 400 {object} backend_internal_proj_storefronts_models.ErrorResponse "Bad request"
// @Failure 401 {object} backend_internal_proj_storefronts_models.ErrorResponse "Unauthorized"
// @Failure 500 {object} backend_internal_proj_storefronts_models.ErrorResponse "Internal server error"
