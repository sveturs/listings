...
// @Success 200 {object} utils.SuccessResponseSwag{data=[]logistics.ProblemShipment} "List of problem shipments"
// @Failure 401 {object} utils.ErrorResponseSwag "Unauthorized"
...
// @Produce json
// @Security Bearer
// @Success 200 {object} utils.SuccessResponseSwag{data=logistics.DashboardStats} "Dashboard statistics"
// @Failure 401 {object} utils.ErrorResponseSwag "Unauthorized"
