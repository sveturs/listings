...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=[]backend_internal_proj_delivery_models.Provider} "List of providers"
// @Failure 500 {object} backend_pkg_utils.ErrorResponseSwag "Server error"
...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=backend_internal_proj_delivery_models.DeliveryAttributes} "Product attributes"
...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=backend_internal_proj_delivery_models.CategoryDefaults} "Category defaults"
...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=backend_internal_proj_delivery_models.Shipment} "Created shipment"
// @Failure 400 {object} backend_pkg_utils.ErrorResponseSwag "Invalid request"
// @Failure 500 {object} backend_pkg_utils.ErrorResponseSwag "Server error"
...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=backend_internal_proj_delivery_models.Shipment} "Shipment info"
