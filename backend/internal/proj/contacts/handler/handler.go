...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=models.UserContact} "Контакт успешно добавлен"
...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=models.ContactsListResponse} "Список контактов"
...
// @Param page query int false "Номер страницы" default(1)
// @Param limit query int false "Количество на странице" default(20)
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=models.ContactsListResponse} "Список входящих запросов"
// @Failure 500 {object} backend_pkg_utils.ErrorResponseSwag "contacts.fetchError"
// @Security BearerAuth
...
// @Accept json
// @Produce json
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=models.UserPrivacySettings} "Настройки приватности"
...
// @Success 200 {object} backend_pkg_utils.SuccessResponseSwag{data=models.UserPrivacySettings} "Обновленные настройки"
// @Failure 400 {object} backend_pkg_utils.ErrorResponseSwag "validation.invalidRequest"
