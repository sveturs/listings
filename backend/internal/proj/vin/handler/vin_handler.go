...
// @Success 200 {object} utils.SuccessResponse "VIN валиден"
// @Failure 400 {object} utils.ErrorResponse "VIN невалиден"
...
// @Success 200 {object} utils.SuccessResponse "История проверок"
...
// @Success 200 {object} utils.SuccessResponse "Данные для автозаполнения"
// @Failure 400 {object} utils.ErrorResponse "Некорректный запрос"
// @Failure 401 {object} utils.ErrorResponse "Не авторизован"
// @Failure 500 {object} utils.ErrorResponse "Внутренняя ошибка сервера"
...
// @Accept json
// @Produce json
// @Success 200 {object} utils.SuccessResponse "Статистика"
// @Failure 401 {object} utils.ErrorResponse "Не авторизован"
// @Failure 500 {object} utils.ErrorResponse "Внутренняя ошибка сервера"
...
// @Failure 400 {object} utils.ErrorResponse "Некорректный VIN"
// @Failure 401 {object} utils.ErrorResponse "Не авторизован"
// @Failure 500 {object} utils.ErrorResponse "Внутренняя ошибка сервера"
