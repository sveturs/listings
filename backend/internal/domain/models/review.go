...
type Review struct {
	...
	EntityOriginType string `json:"entity_origin_type,omitempty"` // тип оригинального объекта (user, storefront)
	EntityOriginID   int    `json:"entity_origin_id,omitempty"`   // ID оригинального объекта
...
// UserRatingSummary представляет обобщенную статистику рейтинга пользователя
...
// StorefrontRatingSummary представляет обобщенную статистику рейтинга витрины
type StorefrontRatingSummary struct {
