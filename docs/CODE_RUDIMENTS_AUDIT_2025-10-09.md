...
### Фаза 2: Важные улучшения (4-5 часов)
**Приоритет:** 🟡 Средний
**Оценка:** 4-5 часов
...
14. ✅ Настроить inventory тесты (7 тестов)
...
**Результат:** Удаление ~85KB backend + ~500 строк frontend
...
### Фаза 2 (Важная):
- [ ] Рефакторинг CreateOrder
- [ ] Удалены scripts/.tmp/ (6 файлов)
- [ ] Удалены дублирующиеся JWT утилиты
- [ ] Удалена LoginResponse
- [ ] Удалён config.MarketplaceIndex
- [ ] Настроены inventory тесты
- [ ] Удалены устаревшие страницы Frontend
- [ ] Перемещены тестовые скрипты
- [ ] Заменён прямой fetch

### Фаза 3 (Улучшения):
- [ ] Стандартизирован JWT middleware (15 модулей)
- [ ] Мигрирован AdminRequired (2 модуля)
- [ ] Решён вопрос с CSRF
- [ ] Удалены hardcoded admin IDs
- [ ] Проведён аудит scripts/
- [ ] Унифицированы компоненты Frontend
- [ ] Удалены неиспользуемые утилиты
- [ ] Удалён закомментированный код
- [ ] Перемещены demo компоненты
