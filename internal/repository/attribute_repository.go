...
type AttributeRepository interface {
	...
	// Category Linking
	LinkToCategory(ctx context.Context, categoryID string, attributeID int32, settings *domain.CategoryAttributeSettings) (*domain.CategoryAttribute, error)
	...
	UnlinkFromCategory(ctx context.Context, categoryID string, attributeID int32) error
